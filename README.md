...
The models tested were: Random Forest Classifier, MultiLayerPerceptron (FFNN i.e feed forward neural network), Gradient Boost Classifier.
...
3. The classification notebook shows different cells training different models for text, speech, and text & speech. All models leveraged sklearn libraries. The following models yielded the best performance and were chosen for further analysis:
...
4. In total, the 9 csv files are:
